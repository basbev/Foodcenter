          ...
          <form>
            <div class="field">
              <div class="control has-icons-left has-icons-right">
                <input class="input is-large" type="text" placeholder="ชื่อร้าน" autofocus="" id="user" v-model="name">
                <input class="input is-large" type="text" placeholder="เบอร์โทร" autofocus="" id="user" v-model="tel">
